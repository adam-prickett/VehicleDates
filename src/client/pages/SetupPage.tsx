...
export function SetupPage() {
  ...
  const inputCls = "w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2.5 text-base bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Welcome to Vehicle Dates</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Create your administrator account to get started</p>
        </div>
